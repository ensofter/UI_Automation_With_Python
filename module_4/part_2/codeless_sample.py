...
class TestTestregistration():
  ...
  def test_testregistration(self):
    ...
    self.driver.find_element(By.ID, "id_registration-email").send_keys("giga.al@stepik.com")
    self.driver.find_element(By.ID, "id_registration-password1").click()
    self.driver.find_element(By.ID, "id_registration-password1").send_keys("password!")
    self.driver.find_element(By.ID, "id_registration-password2").click()
    self.driver.find_element(By.ID, "id_registration-password2").send_keys("password!")
